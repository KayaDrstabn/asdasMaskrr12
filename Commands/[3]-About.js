...
module.exports = {
  data: new SlashCommandBuilder()
    ...
    async execute(interaction, client) {
      ...
      .setTitle("💯 About")
      .setDescription(`
The auth bot ROWY AND ILXO SCRIPT epic/mikayla added better html also redid the authrize system sense it broken for me fixed some other things WORKING on AUTOROLE db and JOIN server with just id cause easier.
